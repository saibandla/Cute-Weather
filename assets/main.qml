...
Page {
    ...
    Container {
       ...
       Container {
           ...
           ImageView {
               imageSource:"asset:///drawable/day_theme.jpg"
       ...
       Container {
           ...
           ImageButton {
               preferredHeight: 80
               preferredWidth: 80
               defaultImageSource: "asset:///drawable/search.png"
       ...
       Container {
           ...
           ImageButton {
               preferredHeight: 60
               preferredWidth: 60
               defaultImageSource: "asset:///drawable/settings.png"
       ...
       Container {
           ...
           ImageView {
               preferredWidth: 35
               preferredHeight: 35
               imageSource: "asset:///drawable/drops.png"
           }
       }
       Container {
           layoutProperties: AbsoluteLayoutProperties {
       ...
       Container {
           ...
           ImageView {
               preferredWidth: 35
               preferredHeight: 35
               imageSource: "asset:///drawable/cloud.png"
           }
       }
       Container {
           layoutProperties: AbsoluteLayoutProperties {
       ...
       Container {
           ...
           ImageView {
               preferredWidth: 35
               preferredHeight: 35
               imageSource: "asset:///drawable/pressure.png"
           }
       }
       Container {
           layoutProperties: AbsoluteLayoutProperties {
       ...
       Container {
           ...
           ImageView {
               id: forecast_img
               imageSource: "asset:///drawable/nodatam.gif"
               preferredHeight: 768
               preferredWidth: 768
           }
       }
...
function hideloader()
    ...
    function loadtemp()
    {
        ...
        if (http.readyState == 4) {
            ...
            if (http.status == 200) {
                ...
                switch (weather.main)
                {
                    case "Clear": forecast_img.imageSource="asset:///drawable/sun.gif"
                    				break ;
                    case "Clouds": if(data_list[0].clouds<="50".valueOf()){forecast_img.imageSource="asset:///drawable/sunnyandcloudy.gif"}else{forecast_img.imageSource="asset:///drawable/cloudy.gif"}
                    				break ;
                    case "Rain": if(data_list[0].rain<="5".valueOf()){forecast_img.imageSource="asset:///drawable/sunnyrain.gif"}else {forecast_img.imageSource="asset:///drawable/rain.gif"}
                    				break;
                    case "Snow": if(data_list[0].snow<="5".valueOf()){forecast_img.imageSource="asset:///drawable/sunsnow.gif"}else{forecast_img.imageSource="asset:///drawable/snow.gif"}
                    				break ;
                }
    ...
    function inches(data)
    {
        ...
        else 
        {
            ...
            if(data_list.rain+""=="undefined")
            {
                rainfall.text="0.0mm"
            }
            else 
            {
                rainfall.textdata_list[0].rain+"".valueOf()
            }
        }
    }
    function  faurenheat(data)
    {
        if(data)
        {
            ...
            var day=data_list[0].temp
            //temp_minmax.text=(day.max*33.8).toFixed(2)+"°F / "+(day.min*33.8).toFixed(2)+"°F"
            temp_minmax.text=((day.max*1.8)+32).toFixed(2)+"°F / "+((day.min*1.8)+32).toFixed(2)+"°F"
        }
        else {
